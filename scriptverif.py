...
# print("res_mse", res_mse, np.shape(res_mse))
# print("res_lin", res_lin, np.shape(res_lin))
# print("delta_mse", delta_mse, np.shape(delta_mse))
# print("grad_lin", grad_lin, np.shape(grad_lin))
# print("delta_lin", delta_lin, np.shape(delta_lin))
